...
{
    public partial class TestProtocols : BaseMorbidityControl
    {
        ...
        public override string Title
        {
            ...
            {
                string title = "";
                if (_classOfTest == ClassOfMorbidityTestEnum.CD4)
                    title = "CD4 Test Protocols";
                else if (_classOfTest == ClassOfMorbidityTestEnum.Chemistry)
                    title = "Chemistry Test Protocols";
                else if (_classOfTest == ClassOfMorbidityTestEnum.Hematology)
                    title = "Hematology Test Protocols";
                else if (_classOfTest == ClassOfMorbidityTestEnum.ViralLoad)
                    title = "Viral Load Test Protocols";
                else if (_classOfTest == ClassOfMorbidityTestEnum.OtherTest)
                    title = "Other Test Protocols";
                return title;
            }
        }
        ...
        public override MorbidityCtrEnum PriviousCtr
        {
            ...
            {
                if (_classOfTest == ClassOfMorbidityTestEnum.CD4)
                    return _forecast.TypeofAlgorithmEnum == AlgorithmType.Serial ? MorbidityCtrEnum.RapidTestSerial : MorbidityCtrEnum.RapidTestParallel;
                if (_classOfTest == ClassOfMorbidityTestEnum.Chemistry)
                    return MorbidityCtrEnum.TestProtocolsCd4;
                if (_classOfTest == ClassOfMorbidityTestEnum.Hematology)
                    return MorbidityCtrEnum.TestProtocolsChem;
                if (_classOfTest == ClassOfMorbidityTestEnum.ViralLoad)
                    return MorbidityCtrEnum.TestProtocolsHem;

                return MorbidityCtrEnum.TestProtocolsVir;
            }
        }
        ...
        public override MorbidityCtrEnum NextCtr
        {
            get
            {
                ...
                if (_classOfTest == ClassOfMorbidityTestEnum.Hematology)
                    return MorbidityCtrEnum.TestProtocolsVir;
                if (_classOfTest == ClassOfMorbidityTestEnum.ViralLoad)
                    return MorbidityCtrEnum.TestProtocolsOther;
